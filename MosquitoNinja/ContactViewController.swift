...
final class ContactViewController: NinjaBaseViewController {
    override func viewDidLoad() {
        ...
        contentStack.addArrangedSubview(body("Owner-operated outdoor pest control for South Jersey residential, commercial and government properties, including mosquito, tick and targeted outdoor fly service."))
        ...
        contentStack.addArrangedSubview(secondaryButton("Email service@njbugninja.com", symbol: "envelope.fill", action: #selector(email)))
    ...
    @objc private func email() { openExternal("mailto:service@njbugninja.com") }
